...
class AdminsDetails extends StatefulWidget {
   ClientUser clients ;
   AdminsDetails({super.key, required this.clients});

  @override
  State<AdminsDetails> createState() => _AdminsDetailsState();
}
...
class _AdminsDetailsState extends State<AdminsDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Compte administrateur",overflow:   TextOverflow.ellipsis,
