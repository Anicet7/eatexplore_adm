...
class _PaiementsState extends State<Paiements> {
                          ...
                          child: Row(
                            ...
                            children: [
                              Align(
                                  ...
                                  child: Text(
                                    "Gestion des demandes de paiements",
                                    maxLines: 3,
                                ...
                                subtitle: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Chip(
                                        backgroundColor: Couleurs.corlor_app_blue_fonce,
                                        label: Text(
                                          80000.toStringAsFixed(2).replaceAllMapped(
                                              RegExp(
                                                  r'(\d{1,3})(?=(\d{3})+(?!\d))'),
                                                  (Match m) => "${m[1]},"),
  ...
  Widget historique_widget ({required ClientUser client})
  {
    ...
    return  Card(
      ...
      child: ListTile(
        ...
        leading: Icon(Icons.monetization_on, size: 35, color: (client.activer == true) ? Colors.green : Colors.red,),
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
