...
import 'restaurant/restaurant_details.dart';

class ComptesRestaurant extends StatefulWidget {
  const ComptesRestaurant({super.key});

  @override
  State<ComptesRestaurant> createState() => _ComptesRestaurantState();
}

class _ComptesRestaurantState extends State<ComptesRestaurant> {
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Align(
                                  ...
                                  child: Text(
                                    "Gestion des comptes restaurant",
                                    maxLines: 3,
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Chip(
                                                backgroundColor: Colors.black,
                                                label: Text(
                                                  70.toStringAsFixed(2).replaceAllMapped(
                                                      RegExp(
                                                          r'(\d{1,3})(?=(\d{3})+(?!\d))'),
                                                          (Match m) => "${m[1]},"),
                      ...
                      Container(
                        ...
                        child: Align(
                            alignment: Alignment.centerLeft,
                            child: Text("Listes des comptes restaurant",
                              maxLines: 3,
                              overflow: TextOverflow.ellipsis,
      ...
      child: ListTile(
        ...
        onTap: (){
          ...
          Navigator.push(
            ...
            PageTransition(
                type: PageTransitionType.rightToLeft,
                child: RestaurantDetails(restaurants:  client),
                inheritTheme: true,
                ctx: context),
          );

        },
        leading: Icon(Icons.store_outlined, size: 35, color: (client.activer == true) ? Colors.green : Colors.red,),
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
